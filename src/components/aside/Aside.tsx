      ...
      <div className="side-wrap">
        ...
        <div className="block-3">
          ...
          <Link
            ...
            style={
              settings
                ? { marginTop: "0px", backgroundColor: "#e6bd1c" }
                : { marginTop: "120px", backgroundColor: "#e6bd1c" }
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span
              ...
              style={
                settings
                  ? { height: "27px", backgroundColor: "#e6bd1c" }
                  : { height: "3px", backgroundColor: "#e6bd1c00" }
              }
            ></span>
            <span
              className="s2"
              style={
                settings
                  ? { height: "3px", backgroundColor: "#e6bd1c00" }
                  : { height: "27px", backgroundColor: "#e6bd5c" }
              }
            ></span>
            <h5
              className="close-t"
              style={settings ? { color: "black" } : { color: "transparent" }}
            >
              Close
            </h5>
        ...
        <div className="block-4" onClick={() => setDark(!dark)}>
          ...
          <svg
            ...
            viewBox="0 0 17 17"
            fill="black"
            style={dark ? { fill: "white" } : { fill: "black" }}
          >
